...
int SimpleTimer::setupTimer( unsigned long d, void *f, void *p, bool h,
                             unsigned n )
{
  int freeTimer;
...
int SimpleTimer::setTimer( unsigned long d, timer_callback_p f, void *p,
                           unsigned n )
{
...
unsigned SimpleTimer::getNumTimers() { return numTimers; }
